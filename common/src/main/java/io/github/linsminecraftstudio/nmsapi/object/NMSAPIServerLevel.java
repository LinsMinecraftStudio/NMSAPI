...
public interface NMSAPIServerLevel {
    @Nullable Entity getNearestEntity(List<? extends NMSAPILivingEntity> entityList, TargetingConditions targetPredicate, @Nullable LivingEntity entity, double x, double y, double z);

    @Nullable NMSAPIPlayer getNearestPlayer(double x, double y, double z, double maxDistance, @Nullable Predicate<Entity> targetPredicate);

    @Nullable NMSAPIPlayer getNearestPlayer(TargetingConditions targetPredicate, LivingEntity entity, double x, double y, double z);
